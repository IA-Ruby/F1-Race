...
void Horizon::drawSunLines(){
    glPushMatrix();
        ...
        glBegin(GL_QUADS);  glVertex3f( 0.99, -0.15, 0);    // 2
                            glVertex3f(    1, -0.10, 0);
                            glVertex3f(   -1, -0.10, 0);
                            glVertex3f(-0.99, -0.15, 0);    glEnd(); 

        glBegin(GL_QUADS);  glVertex3f( 0.97, -0.25, 0);    // 3
                            glVertex3f( 0.98, -0.20, 0);
                            glVertex3f(-0.98, -0.20, 0);
                            glVertex3f(-0.97, -0.25, 0);    glEnd(); 

        glBegin(GL_QUADS);  glVertex3f( 0.94, -0.35, 0);    // 4
                            glVertex3f( 0.96, -0.30, 0);
                            glVertex3f(-0.96, -0.30, 0);
                            glVertex3f(-0.94, -0.35, 0);    glEnd();  

        glBegin(GL_QUADS);  glVertex3f( 0.90, -0.45, 0);    // 5
                            glVertex3f( 0.92, -0.40, 0);
                            glVertex3f(-0.92, -0.40, 0);
                            glVertex3f(-0.90, -0.45, 0);    glEnd();

        glBegin(GL_QUADS);  glVertex3f( 0.84, -0.55, 0);   // 6
                            glVertex3f( 0.87, -0.50, 0);
                            glVertex3f(-0.87, -0.50, 0);
                            glVertex3f(-0.84, -0.55, 0);   glEnd();

        glBegin(GL_QUADS);  glVertex3f( 0.76, -0.65, 0);   // 7
                            glVertex3f( 0.81, -0.60, 0);
                            glVertex3f(-0.81, -0.60, 0);
                            glVertex3f(-0.76, -0.65, 0);   glEnd();
        
        glBegin(GL_QUADS);  glVertex3f( 0.67, -0.75, 0);   // 8
                            glVertex3f( 0.72, -0.70, 0);
                            glVertex3f(-0.72, -0.70, 0);
                            glVertex3f(-0.67, -0.75, 0);   glEnd();
        
        glBegin(GL_QUADS);  glVertex3f( 0.53, -0.85, 0);   // 9
                            glVertex3f( 0.61, -0.80, 0);
                            glVertex3f(-0.61, -0.80, 0);
                            glVertex3f(-0.53, -0.85, 0);   glEnd();

        glBegin(GL_QUADS);  glVertex3f( 0.33, -0.95, 0);   // 10
                            glVertex3f( 0.45, -0.90, 0);
                            glVertex3f(-0.45, -0.90, 0);
                            glVertex3f(-0.33, -0.95, 0);   glEnd();
    glPopMatrix();
}
...
void Horizon::drawSunFrontGlow(){
    ...
    glPushMatrix();
        ...
        glBegin(GL_QUADS);  glColor3ubv(colorLight);
                                glVertex3f( -4, -0.1, 0);
                                glVertex3f(  4, -0.1, 0);
                            glColor4f(0,0,0,0);
                                glVertex3f(  4,    2, 0);
                                glVertex3f( -4,    2, 0);     glEnd();
    glPopMatrix();
}

void Horizon::drawCity(){
    glPushMatrix();
        glTranslatef(sunPos.x, sunPos.y-200, 0);                
        ...
        glPushMatrix();
            ...
            glBegin(GL_POLYGON);    glVertex3f(  0.05,    0, 0);
                                    glVertex3f(  0.10,    0, 0);
            ...
            glBegin(GL_LINES);      glVertex3f( 0.06, 0.30, 0);
        ...
        glPushMatrix();
            ...
            glBegin(GL_POLYGON);    glVertex3f(     0,    0, 0);
                                    ...
                                    glVertex3f(     0, 0.20, 0);    glEnd();
            
            glBegin(GL_LINES);      glVertex3f( 0.02, 0.2, 0);
                                    glVertex3f( 0.02, 0.23, 0);   glEnd();
        glPopMatrix();
        ...
        glPushMatrix();
            ...
            glBegin(GL_QUADS);      glVertex3f(     0,    0, 0);
                                    ...
                                    glVertex3f(  0.30,    0, 0);   glEnd();

            glBegin(GL_QUADS);      glVertex3f(  0.20, 0.10, 0);
                                    glVertex3f(  0.20, 0.20, 0);
                                    glVertex3f(  0.25, 0.20, 0);
                                    glVertex3f(  0.25, 0.10, 0);    glEnd();

            glBegin(GL_POLYGON);    glVertex3f(  0.05, 0.10, 0);
        ...
        glPushMatrix();
            ...
            glBegin(GL_QUADS);      glVertex3f(     0,    0, 0);
                                    ...
                                    glVertex3f(  0.20,    0, 0);   glEnd();

            glBegin(GL_QUADS);      glVertex3f(   0.1, 0.10, 0);
                                    glVertex3f(   0.1, 0.20, 0);
                                    glVertex3f(  0.15, 0.15, 0);
                                    glVertex3f(  0.15, 0.10, 0);    glEnd();

            glBegin(GL_QUADS);      glVertex3f(  0.18, 0.10, 0);   
                                    glVertex3f(  0.18, 0.15, 0);
                                    glVertex3f(  0.20, 0.15, 0);
                                    glVertex3f(  0.20, 0.10, 0);    glEnd();
        glPopMatrix();
